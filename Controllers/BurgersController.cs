...
namespace CambiosTallerMVCJuanAraujo.Controllers
{
    public class BurgersController : Controller
    {
        private readonly CambiosTallerMVCJuanAraujoContext _context;

        public BurgersController(CambiosTallerMVCJuanAraujoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Burger != null ? 
                          ...
                          Problem("Entity set 'CambiosTallerMVCJuanAraujoContext.Burger'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'CambiosTallerMVCJuanAraujoContext.Burger'  is null.");
            }
            var burger = await _context.Burger.FindAsync(id);
            if (burger != null)
            {
